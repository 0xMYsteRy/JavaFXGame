...
public class Tank extends Application {
    ...
    public void loadMap() {
        ...
        Image backgroundImage3 = new Image("file:src/Ultilities/PNG/NguyenCustomBuild/Water_Tile.jpg");
        Image backgroundImage4 = new Image("file:src/Ultilities/PNG/NguyenCustomBuild/Sand.png");
        Image backgroundImage5 = new Image("file:src/Ultilities/PNG/NguyenCustomBuild/Sand2.png");

        // Border image
        Image borderImage1 = new Image("file:src/Ultilities/PNG/NguyenCustomBuild/TopLeftBorder.png");
        Image borderImage2 = new Image("file:src/Ultilities/PNG/NguyenCustomBuild/TopRightBorder.png");
        Image borderImage3 = new Image("file:src/Ultilities/PNG/NguyenCustomBuild/BottomLeftBorder.png");
        Image borderImage4 = new Image("file:src/Ultilities/PNG/NguyenCustomBuild/BottomRightBorder.png");
        ...
        for (int i = 0; i < 20; i++) {
            ...
            if (i % 2 == 0) {
                ...
                imageView[i].setImage(backgroundImage2);
                imageView[i].setFitHeight(70);
                imageView[i].setFitWidth(70);
                imageView[i].setTranslateX(70 * i);
                imageView[i].setTranslateY(700);
        ...
        for (int i = 0; i < 20; i++) {
            ...
            if (i % 2 != 0) {
                ...
                imageView2[i].setImage(backgroundImage2);
                imageView2[i].setFitHeight(70);
                imageView2[i].setFitWidth(70);
                imageView2[i].setTranslateX(70 * i);
                imageView2[i].setTranslateY(630);
        ...
        for (int i = 0; i < 20; i++) {
            ...
            if (i % 2 != 0) {
                imageView3[i].setImage(backgroundImage2);
        ...
        for (int i = 0; i < 20; i++) {
            ...
            if (i % 2 == 0) {
                imageView4[i].setImage(backgroundImage2);
        ...
        for (int i = 0; i < 20; i++) {
            ...
            if (i % 2 != 0) {
                imageView5[i].setImage(backgroundImage2);
        ...
        for (int i = 0; i < 20; i++) {
            ...
            if (i % 2 == 0) {
                imageView6[i].setImage(backgroundImage2);
        ...
        for (int i = 0; i < 20; i++) {
            ...
            if (i % 2 != 0) {
                imageView7[i].setImage(backgroundImage2);
        ...
        for (int i = 0; i < 20; i++) {
            ...
            if (i % 2 == 0) {
                imageView8[i].setImage(backgroundImage2);
        ...
        for (int i = 0; i < 20; i++) {
            ...
            if (i % 2 != 0) {
                imageView9[i].setImage(backgroundImage2);
        ...
        for (int i = 0; i < 20; i++) {
            if (i % 2 == 0) {
                ...
                imageView10[i].setImage(backgroundImage2);
        ...
        for (int i = 0; i < 20; i++) {
            if (i % 2 != 0) {
                ...
                imageView11[i].setImage(backgroundImage2);
        ...
        // Map border
        ImageView[] borderViewBottom = new ImageView[20];
        for (int i = 0; i < 20; i++) {
            borderViewBottom[i] = new ImageView();
            if (i == 0) {
                borderViewBottom[i].setImage(borderImage3);
                borderViewBottom[i].setFitHeight(70);
                borderViewBottom[i].setFitWidth(350);
                borderViewBottom[i].setScaleX(1);
                borderViewBottom[i].setScaleY(1);
                borderViewBottom[i].setTranslateX(70 * i);
                borderViewBottom[i].setTranslateY(630);
            }
            if (i == 5) {
                borderViewBottom[i].setImage(borderImage4);
                borderViewBottom[i].setFitHeight(70);
                borderViewBottom[i].setFitWidth(350);
                borderViewBottom[i].setScaleX(1);
                borderViewBottom[i].setScaleY(1);
        ...
        ImageView[] borderViewTop = new ImageView[20];
        for (int i = 0; i < 20; i++) {
            borderViewTop[i] = new ImageView();
            if (i == 0) {
                borderViewTop[i].setImage(borderImage1);
                borderViewTop[i].setFitHeight(70);
                borderViewTop[i].setFitWidth(350);
                borderViewTop[i].setScaleX(1);
                borderViewTop[i].setScaleY(1);
                borderViewTop[i].setTranslateX(70 * i);
                borderViewTop[i].setTranslateY(0);
            }
            if (i == 5) {
                borderViewTop[i].setImage(borderImage2);
                borderViewTop[i].setFitHeight(70);
                borderViewTop[i].setFitWidth(350);
                borderViewTop[i].setScaleX(1);
                borderViewTop[i].setScaleY(1);
        ...
        tankkk.getChildren().addAll(borderViewTop);
