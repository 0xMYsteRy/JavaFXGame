...
public class Tank extends Application {
    ...
    Group tank=new Group(createTank(1,1,10));
    ...
    public void start(Stage stage) throws Exception {
        ...
        GridPane tankkk =new GridPane();
        tankkk.getChildren().addAll(createTank(1,1,10));
        tankkk.setOnKeyPressed(e -> {
            switch (e.getCode()) {
                case DOWN: tankkk.setLayoutY(tankkk.getLayoutY()+10);
                    System.out.println("DAMN");

                case UP: tankkk.setLayoutY(tankkk.getLayoutY() - 10);
                case LEFT: tankkk.setLayoutX(tankkk.getLayoutX() - 10);
                case RIGHT: tankkk.setLayoutX(tankkk.getLayoutX() + 10);
            }
        });

        tankkk.setRotate(180);
//        tankkk.setLayoutX(200);
//        tankkk.setLayoutY(tankkk.getLayoutY()+100);
        //Displaying the contents of the stage

        Scene scene = new Scene(tankkk,1000, 800);
    ...
    public void Move(GridPane tankkk){
        tankkk.setOnKeyPressed(e -> {
            switch (e.getCode()) {
                case DOWN: tankkk.setLayoutY(tankkk.getLayoutY()+10); break;
                case UP: tankkk.setLayoutY(tankkk.getLayoutY() - 10); break;
                case LEFT: tankkk.setLayoutX(tankkk.getLayoutX() - 10); break;
                case RIGHT: tankkk.setLayoutX(tankkk.getLayoutX() + 10); break;
            }
        });
    }
}
